...
const StudentDashboard = () => {
    ...
    const quickLinks = [
        { title: "Academic", icon: <FaUserGraduate />, color: "bg-pink-500" },
        { title: "Fee", icon: <FaMoneyBill />, color: "bg-green-500" },
        { title: "Circular", icon: <FaBullhorn />, color: "bg-yellow-500" },
        { title: "Exam", icon: <FaFileSignature />, color: "bg-purple-500" },
    ];

    return (
        // The <StudentLayout> wrapper is removed from here
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        {quickLinks.map(link => (
                            <div key={link.title} className="bg-white p-4 rounded-xl shadow-md text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
